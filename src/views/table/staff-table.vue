<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="职位" prop="postId" align="center" width="150">
        <template slot-scope="{row}">
          <span>{{ row.postName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="员工姓名" align="center" min-width="150px">
        <template slot-scope="{row}">
      ...
      <el-table-column label="工作状态" align="center" class-name="status-col" width="100">
        <template slot-scope="{row}">
